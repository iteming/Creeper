    ...
    public static class ShareUtil
    {
        ...
        public static string Getaccesstoken()
        {
            ...
            if (srcString.Contains("access_token"))
            {
                ...
                SessionHelper._SessionHelper.SetSession("access_tokenzj", strjson);
            }
            return strjson;
        }
        ...
        {
            string accesstoken = (string)SessionHelper._SessionHelper.GetSession("access_tokenzj");
            ...
            if (srcString.Contains("ticket"))
            {
                ...
                SessionHelper._SessionHelper.SetSession("ticketzj", strjson);
            }
            return strjson;
        }
        ...
        {
            if (SessionHelper._SessionHelper.GetSession("access_tokenzj") == null)
            {
                Getaccesstoken();
            }
            if (SessionHelper._SessionHelper.GetSession("ticketzj") == null)
            {
                Getjsapi_ticket();
            }
            ...
            string str = "jsapi_ticket=" + (string)SessionHelper._SessionHelper.GetSession("ticketzj") + "&noncestr=" + nonceStr +
