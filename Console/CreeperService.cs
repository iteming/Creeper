...
namespace Console
{
    public class CreeperService
    {
        ...
        public string GetValidateImage(ref MyClass mc)
        {
            ...
            var data = ToolsHelper._HttpHelper.SendAsyncByGet(ref mc);
        ...
        public string GetAllAgent(ref MyClass mc, int gid = 0)
        {
            ...
            var data = ToolsHelper._HttpHelper.SendAsyncByGet(ref mc);
            System.Console.Write(data);
            LogHelper.WriteToLog("GetAllAgent[代理商管理]:" + data, strFileName);
            return data;
        }
        ...
        public string EachProductAgentCountDistributionDetail(ref MyClass mc, int gid = 10013, int aglid = 1)
        {
            ...
            var data = ToolsHelper._HttpHelper.SendAsyncByGet(ref mc);
            System.Console.Write(data);
            LogHelper.WriteToLog("EachProductAgentCountDistributionDetail[代理商一览 详情]:" + data, strFileName);
            return data;
        }
        /// <summary>
        /// 用户一览 详情
