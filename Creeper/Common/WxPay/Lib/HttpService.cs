...
namespace Common.WxPay.Lib
{
    ...
    public class HttpService
    {
        ...
        public static string Post(string xml, string url, bool isUseCert, int timeout)
        {
            ...
            try
            {
                ...
                * ************************************************************/
                ...
                //设置代理服务 器
                if (PayConfig.ProxyEnable() == "1")
                {
                    WebProxy proxy = new WebProxy(PayConfig.ProxyIP(), int.Parse(PayConfig.ProxyPoint()));                          //定义一个网关对象
        ...
        public static string Post(string str, string url, int timeout)
        {
            System.GC.Collect();//垃圾回收，回收没有正常关闭的http连接
